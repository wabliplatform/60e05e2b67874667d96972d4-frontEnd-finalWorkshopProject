...
if(insideSubDataElement !== null && data[data.length -i -1].pImage !== undefined){
  ...
  subDataElements[i-(chunk-1) *subDataElements.length].name = data[data.length -i -1].pImage.name;
      ...
      const insideSubDataElement = subDataElements[i-(chunk-1) *subDataElements.length].querySelector("[annotationname = 'pEnd']");
      if(insideSubDataElement !== null){
        insideSubDataElement.textContent = data[data.length -i -1].pEnd;
        
      }
      else if(subDataElements[i-(chunk-1) *subDataElements.length].getAttribute('annotationname') === 'pEnd'){
        subDataElements[i-(chunk-1) *subDataElements.length].textContent = data[data.length -i -1].pEnd;
    ...
    {  
      ...
      newMap.forEach((value, key) => {
        if (
          ...
          document
            .getElementById(key)
            .contains(document.getElementById("io48n9")) === true &&
            document.getElementById(key).contains(document.getElementById(parentId)) === false
        ) {
          transitionId = value._id;
          parentId = key;
    ...
    {  
      ...
      newMap.forEach((value, key) => {
        if (
          ...
          document
            .getElementById(key)
            .contains(document.getElementById("ihjac6")) === true &&
            document.getElementById(key).contains(document.getElementById(parentId)) === false
        ) {
          transitionId = value._id;
          parentId = key;
    ...
    {  
      ...
      newMap.forEach((value, key) => {
        if (
          ...
          document
            .getElementById(key)
            .contains(document.getElementById("iqoqh")) === true &&
            document.getElementById(key).contains(document.getElementById(parentId)) === false
        ) {
          transitionId = value._id;
          parentId = key;
    ...
    {  
      ...
      newMap.forEach((value, key) => {
        if (
          ...
          document
            .getElementById(key)
            .contains(document.getElementById("iihxj")) === true &&
            document.getElementById(key).contains(document.getElementById(parentId)) === false
        ) {
          transitionId = value._id;
          parentId = key;
    ...
    {  
      ...
      newMap.forEach((value, key) => {
        if (
          ...
          document
            .getElementById(key)
            .contains(document.getElementById("inppv")) === true &&
            document.getElementById(key).contains(document.getElementById(parentId)) === false
        ) {
          transitionId = value._id;
          parentId = key;
